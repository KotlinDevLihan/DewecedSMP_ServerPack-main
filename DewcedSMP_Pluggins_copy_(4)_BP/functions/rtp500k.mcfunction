...
execute @s[tag=rtpvali] ~~~ scoreboard players set @s rtpdis 500
...
execute @s[tag=rtpvali] ~~~ scoreboard players random @e[tag=sirobGPS] x_tp -500000 500000
execute @s[tag=rtpvali] ~~~ scoreboard players set @e[tag=sirobGPS] y_tp 255
execute @s[tag=rtpvali] ~~~ scoreboard players random @e[tag=sirobGPS] z_tp -500000 500000
execute @s[tag=rtpvali] ~~~ summon sirob:gps_tp
tag @s[tag=!rtpvali,tag=!rtp_using] add rtp_can
scoreboard players set @s[tag=!rtpvali,tag=!rtp_using] rtpdis 500
